...
// Adapted for WeeWX Weather34 skin by Ian Millard
...
?> <?php echo $error; ?>
  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="pwd" >
   Enter Your Password For Setup Screen Below
<center> <div class="modal-buttons">
     <input name="passwd" type="password" class="input-button"/>  <input type="submit" name="submit_pwd" value="Login " class="modal-button" />
      ...
      <?php echo "2015-" ;?><?php echo date('Y');?> &copy;</a> WeeWX WEATHER34 UB<span style="color:rgba(236, 87, 27, 1.000);">40.1</span>-IHVN</span></span></span>
      <br/><br/>
...
Welcome you have logged into the WeeWX WEATHER34 Skin setup screen <?php echo date("d M Y H:i"); ?>
</span>
</div>
</div></div>
</div></div>
...
<div class="weatheroptionssidebar">
<?php echo $iicon;?> Database settings not required for WeeWX users..
...
<span style="color:rgba(86, 95, 103, 1.000)">
     <?php echo $iicon;?> getting the path correct is essential for live realtime data display <span style="color:#FF793A">(/var/www/weewx/w34realtime.txt)</span></span>
...
WeeWX Software Path to Data file</div><br/>
    ...
    <path d="M30 12 L16 24 2 12" />
       ...
       <label name="weatherhardware"></label>
        <select id="weatherhardware" name="weatherhardware" class="chooseapi">
           ...
           <option>Fine Offset WH2650A RTL-SDR(RTL2832U)</option>
      ...
      <div class="stationvalue">Which Platform Do You Use</div>
      <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="#F05E40" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
...
<!--##########################################################################################
   ...
   <label name="showDate"></label>
     ...
     <span style="color:rgba(86, 95, 103, 1.000);font-weight:normal;"><?php echo $oiicon;?> false = </span> <span style="color:#777;font-weight:normal;">not used as of 27th April 2017 always false</span>
...
<div class="weatheroptions">
  ...
  <br/>
    ...
    <span style="font-size:12px;color:#777;"><center><svg id="i-info" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M16 14 L16 23 M16 8 L16 10" />
    <circle cx="16" cy="16" r="14" />
</svg> WeeWX Weather34 EASYWXSETUP &copy; 2015-<?php echo date('Y');?> Dashboard WX-UB40</center</span><br>
