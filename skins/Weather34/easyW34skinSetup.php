...
$jsondatapath = "'. $_POST["jsondatapath"]. '";
$aqitoken = "'. $_POST["aqitoken"]. '";
$ds_url = "'. $_POST["ds_url"]. '";
$ds_interval = "'. $_POST["ds_interval"]. '";
$ds_filename = "'. $_POST["ds_filename"]. '";
$wu_url = "'. $_POST["wu_url"]. '";
$wu_interval = "'. $_POST["wu_interval"]. '";
$wu_filename = "'. $_POST["wu_filename"]. '";
$eq_url = "'. $_POST["eq_url"]. '";
$eq_interval = "'. $_POST["eq_interval"]. '";
$eq_filename = "'. $_POST["eq_filename"]. '";
$ki_url = "'. $_POST["ki_url"]. '";
$ki_interval = "'. $_POST["ki_interval"]. '";
$ki_filename = "'. $_POST["ki_filename"]. '";
$me_url = "'. $_POST["me_url"]. '";
$me_header = "'. $_POST["me_header"]. '";
$me_interval = "'. $_POST["me_interval"]. '";
$me_filename = "'. $_POST["me_filename"]. '";
$aq_url = "'. $_POST["aq_url"]. '";
$aq_interval = "'. $_POST["aq_interval"]. '";
$aq_filename = "'. $_POST["aq_filename"]. '";
$pu_url = "'. $_POST["pu_url"]. '";
$pu_interval = "'. $_POST["pu_interval"]. '";
$pu_filename = "'. $_POST["pu_filename"]. '";
...
<span style="color:rgba(86, 95, 103, 1.000)">
     <?php echo $iicon;?> getting the path correct is essential for live realtime data display <span style="color:#FF793A"> example (/var/www/html/weewx/w34realtime.txt)</span></span><br/><br/>
...
your nearly there :-) keep going</div>
...
<!--##########################################################################################
   ...
   <div class="weathersectiontitle">WU/Darksky Options</div><br/><br/>
    ...
    <br/><span style="color:rgba(236, 87, 27, 1.000);">**New API Version Key Required</span>
...
<br/> <?php echo $iicon;?> <span style="color:#777;"><green>CA</green> same as si, windSpeed km/h</span>
<br/> <?php echo $iicon;?> <span style="color:#777;"><green>UK2</green>  same as si,windSpeed mph</span>
<br/> <?php echo $iicon;?> <span style="color:#777;"><green>US</green> Imperial units (NON METRIC)</span>
<br/> <?php echo $iicon;?> <span style="color:#777;"><green>SI</green> units</span>
<br/><span style="color:rgba(86, 95, 103, 1.000);">*IMPORTANT</span> NEW DARKSKY API (uses old script originally used in  2016) requires personal API KEY (MAY 30TH 2018) available via <a href="https://darksky.net/dev/docs" title="https://darksky.net/dev/docs" target="_blank">https://darksky.net/dev/docs</a>
<br/><br/>
...
<div class="weatheroptions">
  ...
  Web Services Update Frequency</div><br/>

  <label name="unit"></label>
  <div class="stationvalue">Dark Sky</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
        <select id="ds_interval" name="ds_interval" class="choose1">
...
<br/>
        <label name="wu_interval"></label>
        <div class="stationvalue">Weather Underground</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
    ...
    <br/>
     ...
     <label name="eq_interval"></label>
    <div class="stationvalue">Earthquake Report</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
        <select id="eq_interval" name="eq_interval" class="choose1">
       <option><?php echo $ds_interval ;?></option>
            <option>3600</option>
          	<option>43200</option>
...
<br/>
        <label name="ki_interval"></label>
        <div class="stationvalue">Planetary K-Index</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
        <select id="ki_interval" name="ki_interval" class="choose1">
        <option><?php echo $ki_interval ;?></option>
            <option>3600</option>
          	<option>43200</option>

        </select>
        <br/>
        <label name="me_interval"></label>
        <div class="stationvalue">Metar&nbsp;</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
...
<br/>
        ...
        <label name="aq_interval"></label>
        <div class="stationvalue">Air Quality Index</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="14" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
        ...
        <br/>
        <label name="pu_interval"></label>
        <div class="stationvalue">Purple Air</div> <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M12 30 L24 16 12 2" />
</svg><svg id="i-chevron-bottom" viewBox="0 0 32 32" width="10" height="10" fill="#777" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M30 12 L16 24 2 12" />
</svg>
...
<!--##########################################################################################
   ...
   <div class="weatheroptionssidebar"><svg id="i-alert" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
